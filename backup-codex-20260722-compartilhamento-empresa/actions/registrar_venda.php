...
try {
    ...
    // Notifica toda a equipe uma única vez quando a meta mensal for alcançada.
    ...
    if ($valorMeta > 0) {
        ...
        if ($totalMes >= $valorMeta) {
            $tituloMeta = 'Parabéns, equipe! Meta mensal alcançada! 🎉';
            $mensagemMeta = 'A equipe alcançou a meta de R$ ' . number_format($valorMeta,2,',','.') . '. Total realizado: R$ ' . number_format($totalMes,2,',','.') . '. Obrigado pelo empenho de todos!';
