...
<head>
    <meta charset="UTF-8">
    <title>Cadastro de Contas BancÃ¡rias</title>
...
<body>
<div class="container">
    <h1><i class="fa-solid fa-university"></i> Minhas Contas BancÃ¡rias</h1>
            ...
            <tbody>
                <?php if ($result && $result->num_rows > 0): ?>
                    ...
                    <tr>
                        ...
                        <td data-label="AgÃªncia"><?= htmlspecialchars($row['agencia']) ?></td>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="5" class="text-center">Nenhuma conta bancÃ¡ria cadastrada.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
