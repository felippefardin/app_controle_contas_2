...
if (!$pessoa) {
    echo "<div class='container' style='background-color: #222; padding: 25px; border-radius: 8px; margin-top: 30px; color: #eee;'>Registro ṇo encontrado ou voc̻ ṇo tem permisṣo.</div>";
