...
<head>
    ...
    <style>
        ...
        .container { 
            width: 95%;             /* Ocupa a largura disponÃ­vel com margem de seguranÃ§a */
            max-width: 1400px;      /* Limite para telas ultrawide (Full Desktop) */
            margin: 20px auto; 
            background-color: #1f1f1f; 
            padding: 30px; 
            border-radius: 8px; 
            box-sizing: border-box; /* Garante que padding nÃ£o estoure a largura */
        }
        ...
        .actions { 
            text-align: right; 
            white-space: nowrap; /* Evita que botÃµes quebrem linha no desktop */
            width: 1%; /* ForÃ§a a coluna a ocupar apenas o espaÃ§o necessÃ¡rio */
        }
        ...
        .btn-icon { 
            ...
            padding: 5px; /* Aumenta Ã¡rea de clique */
            display: inline-flex;
            align-items: center;
            gap: 5px;
        }
        ...
        .modal { 
            ...
            align-items: center; 
            padding: 10px; /* EspaÃ§o nas bordas em mobile */
        ...
        @media (max-width: 768px) {
            ...
            .container {
                ...
                padding: 15px;
                margin: 10px 0;
                border-radius: 0; /* Remove bordas arredondadas em telas muito pequenas para aproveitar espaÃ§o */
            }
            ...
            /* BotÃ£o Add ocupa largura total no mobile para facilitar o clique */
            .btn-add {
                width: 100%;
                text-align: center;
                margin-bottom: 20px;
            ...
            /* Coluna de aÃ§Ãµes: empilha ou ajusta Ã­cones */
            .actions {
                width: auto;
                text-align: right;
            }
            ...
            .btn-icon {
                ...
                /* Removemos o texto no mobile se ficar muito apertado, 
                   mas aqui vamos manter e ajustar o espaÃ§amento */
                padding: 8px; /* Ãrea de toque maior */
                background-color: #2a2a2a; /* Fundo sutil para parecer botÃ£o tÃ¡til */
                border-radius: 4px;
            }
        ...
        @media (max-width: 400px) {
            .btn-icon span {
                display: none; /* Esconde o texto "Editar/Excluir" mantendo sÃ³ o Ã­cone */
            }
            .btn-icon i {
                margin-right: 0;
            }
...
<div class="container">
    ...
    <button class="btn-add" onclick="abrirModal()">âž• Nova Categoria</button>
...
<div id="deleteModal" class="modal">
    <div class="modal-content">
        ...
        <h3 style="color:#e74c3c">Confirmar ExclusÃ£o</h3>
        <p>Tem certeza que deseja excluir a categoria <strong id="nomeExclusao"></strong>?</p>
        <p style="font-size:0.9em; color:#aaa;">Isso removerÃ¡ a associaÃ§Ã£o com todos os lanÃ§amentos existentes.</p>
