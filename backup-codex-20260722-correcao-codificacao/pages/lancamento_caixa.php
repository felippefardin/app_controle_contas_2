...
// âœ… EXIBE MENSAGEM FLUTUANTE CENTRALIZADA
...
<div class="container">
    ...
    <h2>LanÃ§amento de Caixa DiÃ¡rio</h2>
    ...
    <form action="../actions/add_caixa_diario.php" method="post">
        ...
        <button type="submit" class="btn-primary">Salvar LanÃ§amento</button>
    </form>

    <div class="search-container">
        <h3>Filtrar por PerÃ­odo</h3>
        <div class="form-group">
        ...
        <button class="btn-pdf" onclick="gerarPDFPeriodo()">Salvar PDF do PerÃ­odo</button>
    </div>

    <hr>

    <h3>HistÃ³rico de LanÃ§amentos</h3>
        ...
        <table id="lancamentosTable">
            ...
            <tbody>
                <?php if (!empty($lancamentos)): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr><td colspan="3">Nenhum lanÃ§amento encontrado.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
...
<div id="modalExcluir" class="modal">
    <div class="modal-content">
        ...
        <h3 style="color: #dc3545;">Confirmar ExclusÃ£o</h3>
        <p>Tem certeza que deseja excluir este lanÃ§amento?</p>
...
function gerarPDFPeriodo() {
    ...
    const doc = new jsPDF();
    doc.setFontSize(18);
    doc.text("HistÃ³rico de LanÃ§amentos de Caixa", 14, 22);
    ...
    if (rows.length === 0) return alert('NÃ£o hÃ¡ lanÃ§amentos visÃ­veis.');
