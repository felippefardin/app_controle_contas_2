    ...
    <table class="table table-dark table-hover">
        ...
        <tbody>
            ...
            <tr class="venda" data-id="<?= $venda['id'] ?>">
                <td><?= $venda['id'] ?></td>
                <td><?= htmlspecialchars($venda['nome_cliente'] ?? 'Cliente BalcÃ£o') ?></td>
...
<div class="modal fade" id="modalConfirmarCancelamento" tabindex="-1" role="dialog" aria-hidden="true" style="z-index: 1060;"> <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content bg-dark text-light border-danger">
            ...
            <div class="modal-body text-center">
                ...
                <p class="small text-muted">O estoque serÃ¡ devolvido e os lanÃ§amentos financeiros removidos. Esta aÃ§Ã£o nÃ£o pode ser desfeita.</p>
            </div>
            <div class="modal-footer border-top-0 justify-content-center">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">NÃ£o, Voltar</button>
...
$(function() {
    ...
    // FunÃ§Ã£o para exibir alertas na tela
    ...
    // 3. Confirmar o cancelamento no Modal de ConfirmaÃ§Ã£o
    $('#btn-confirmar-exclusao').click(function() {
        ...
        .catch(err => {
            ...
            $('#modalConfirmarCancelamento').modal('hide');
            showAlert('Erro de comunicaÃ§Ã£o com o servidor.', 'danger');
            btn.prop('disabled', false).html('Sim, Cancelar Venda');
        });
    });
});
