...
// 1. VERIFICA O LOGIN E PEGA A CONEXÃƒO
...
if ($conn === null) {
    set_flash_message('danger', 'Erro de conexÃ£o com banco de dados.');
...
if (!$id_usuario || $id_conta === 0) {
    set_flash_message('danger', 'Conta nÃ£o identificada.');
    header("Location: contas_pagar.php");
    exit;
}

// LÃ“GICA DE ATUALIZAÃ‡ÃƒO (POST)
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $valor = brl_to_float($_POST['valor']); // Usa a funÃ§Ã£o segura global
...
if ($result->num_rows !== 1) {
    echo "<div class='container'><h3 style='color:#c0392b'>Conta nÃ£o encontrada.</h3></div>";
    ...
    <div class="container">
        ...
        <form method="POST" action="editar_conta_pagar.php">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="numero">NÃºmero do Documento</label>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" id="id_categoria" name="id_categoria" required>
                        ...
                        if ($categorias_result) {
                            // Reinicia o ponteiro do resultado se necessÃ¡rio ou busca novamente se a lÃ³gica acima consumiu
                ...
                <div class="form-group col-md-6">
                    <label for="descricao">DescriÃ§Ã£o / ObservaÃ§Ã£o</label>
