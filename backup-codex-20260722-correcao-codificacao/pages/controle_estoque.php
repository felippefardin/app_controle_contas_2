...
<div class="container">
    ...
    if (isset($_SESSION['produtos_estoque_baixo']) && !empty($_SESSION['produtos_estoque_baixo'])) {
        ...
        echo '<strong>AtenÃ§Ã£o!</strong> Os seguintes produtos estÃ£o com estoque baixo:';
        echo '<ul>';
            ...
            <form action="../actions/cadastrar_produto_action.php" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <label for="codigo">CÃ³digo/SKU</label>
                        <input type="text" class="form-control" name="codigo" placeholder="CÃ³d. Opcional">
                    </div>
                    ...
                    <div class="form-group col-md-2"> <label for="quantidade_minima">Qtd. MÃ­nima</label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="preco_compra">PreÃ§o de Compra</label>
                        <input type="text" class="form-control money-mask" name="preco_compra" placeholder="0,00">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="preco_venda">PreÃ§o de Venda</label>
                ...
                <h5>InformaÃ§Ãµes Fiscais (para emissÃ£o de NFe)</h5>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <small class="form-text text-muted">CÃ³digo Fiscal de OperaÃ§Ãµes e PrestaÃ§Ãµes.</small>
                    </div>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalLabel">Confirmar ExclusÃ£o</h5>
