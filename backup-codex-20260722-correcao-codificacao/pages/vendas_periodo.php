...
if ($conn === null) {
    die("Falha de conexÃ£o com o banco de dados.");
}
...
<head>
    ...
    <title>RelatÃ³rio de Vendas e ComissÃ£o</title>
    ...
    <style>
        ...
        .form-group { 
            flex: 1; 
            min-width: 200px; /* Garante que nÃ£o fique muito espremido */
        }
...
<div class="container">
    <h2><i class="fas fa-chart-line"></i> Vendas por PerÃ­odo & ComissÃ£o</h2>
    ...
    <div class="results-box">
        ...
        <div class="card-result card-comissao">
            <h3>ComissÃ£o (<?= $porcentagem_comissao ?>%)</h3>
                ...
                <tbody>
                    <?php foreach ($vendas as $venda): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($venda['nome_cliente'] ?? 'Cliente nÃ£o iden.') ?></td>
    ...
    <?php else: ?>
        <p style="text-align: center; color: #aaa; margin-top: 20px;">Nenhuma venda encontrada neste perÃ­odo.</p>
    <?php endif; ?>
    ...
    <div style="margin-top: 20px; text-align: right;">
        <button onclick="window.print()" style="background: #555; color: #fff; border: none; padding: 10px 15px; border-radius: 5px; cursor: pointer;">
            <i class="fas fa-print"></i> Imprimir RelatÃ³rio
        </button>
    </div>
