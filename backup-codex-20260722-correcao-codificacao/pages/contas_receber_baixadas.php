  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    table { 
        ...
        min-width: 800px; /* ForÃ§a largura mÃ­nima para layout correto */
    }
...
<div id="estornarModal" class="modal">
    <div class="modal-content">
      ...
      <p style="color: #aaa; font-size: 0.9em;">A conta voltarÃ¡ para a lista de <strong>Contas a Receber (Pendentes)</strong>.</p>
