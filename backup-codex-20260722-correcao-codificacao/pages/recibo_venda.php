...
if ($conn === null) die("Erro de conexÃ£o.");

// âœ… CORREÃ‡ÃƒO DO ERRO (Linha 20 original)
// Pega o ID direto da variÃ¡vel correta, nÃ£o do array booleano
...
if (!$venda) {
    ...
    echo "<div class='container mt-5'><div class='alert alert-danger'>Venda nÃ£o encontrada ou permissÃ£o negada.</div><a href='vendas.php' class='btn btn-secondary'>Voltar</a></div>";
...
<head>
    ...
    .header { 
        text-align: center; 
        border-bottom: 2px solid #000; /* Linha um pouco mais sÃ³lida para desktop */
        padding-bottom: 15px; 
        margin-bottom: 20px; 
    }
    ...
    @media (max-width: 768px) {
        ...
        .btn-print {
            display: block;
            width: 100%; /* BotÃ£o full width no mobile */
            margin: 10px 0;
            padding: 15px;
            font-size: 16px;
        }
...
<div class="recibo-container">
    ...
    <div class="actions">
        <button onclick="window.print()" class="btn-print">ðŸ–¨ï¸ Imprimir Recibo</button>
        <a href="vendas.php" class="btn-print btn-back">â¬…ï¸ Voltar</a>
    </div>
</div>
