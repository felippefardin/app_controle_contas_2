...
if (!$registro) {
    echo "<div class='container'><h1>Conta nÃ£o encontrada ou acesso negado.</h1></div>";
...
<head>
    <meta charset="UTF-8">
    <title>Editar Conta BancÃ¡ria</title>
...
<body>
<div class="container">
    <h1><i class="fa-solid fa-pen-to-square"></i> Editar Conta BancÃ¡ria</h1>
