...
// INCLUI O HEADER PADRÃƒO (JÃ¡ abre a tag <main>)
...
// --- 3. PROJEÃ‡ÃƒO INTELIGENTE (Utilizando a funÃ§Ã£o centralizada no utils.php) ---
...
<div class="report-wrapper">
    <div class="report-card-container" id="pdf-content">
        ...
        <h3 class="section-title">AnÃ¡lise de SaÃºde e ProjeÃ§Ã£o</h3>
        <div class="report-row">
            <div class="summary-card <?= $saldoPrevisto >= 0 ? 'card-positive' : 'card-negative' ?>">
                <i class="fa-solid fa-scale-balanced"></i>
                <h5>Saldo Projetado (MÃªs Atual)</h5>
            ...
            <div class="summary-card <?= $projesao60Dias >= 0 ? 'card-positive' : 'card-negative' ?>">
                ...
                <h5>TendÃªncia (PrÃ³ximos 60 dias)</h5>
                <p>R$ <?= number_format($projesao60Dias, 2, ',', '.') ?></p>
                <span><?= $projesao60Dias < 0 ? "âš ï¸ Risco de caixa baixo detectado" : "âœ… HistÃ³rico indica fluxo positivo" ?></span>
            </div>
        </div>

        <h3 class="section-title">BalanÃ§o Previsto (MÃªs Atual)</h3>
        <div class="report-row">
            <div class="summary-card">
                <i class="fa-solid fa-arrow-down"></i>
                <h5>A Receber (MÃªs)</h5>
        ...
        <h3 class="section-title">BalanÃ§o Realizado (Caixa e MÃªs)</h3>
        <div class="report-row">
            <div class="summary-card">
        ...
        <div class="chart-container">
            <h4>Fluxo de Caixa e TendÃªncia HistÃ³rica</h4>
