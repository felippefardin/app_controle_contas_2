...
<div class="main-container">
    ...
    <form class="search-form" method="GET" action="">
      ...
      <input type="date" name="data_inicio" placeholder="Data InÃ­cio" value="<?php echo htmlspecialchars($_GET['data_inicio'] ?? ''); ?>">
    ...
    if ($result && $result->num_rows > 0) {
        ...
        echo "<thead><tr>
                ...
                <th>Fornecedor</th>
                <th>NÃºmero</th> <th>DescriÃ§Ã£o</th>
                <th>Valor</th>
                <th>Baixado Por</th>
                <th>Data Baixa</th>
                <th>Categoria</th>
...
// === LÃ“GICA DE AÃ‡ÃƒO EM MASSA (BULK) ===
...
function submitBulkExcluir() {
    ...
    .catch(err => alert('Erro na requisiÃ§Ã£o'));
}
