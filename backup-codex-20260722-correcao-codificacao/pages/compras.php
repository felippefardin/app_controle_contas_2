...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['acao_modal']) && $_POST['acao_modal'] === 'salvar_novo_produto') {
    ...
    // $categoria   = $_POST['categoria']; // Removido pois nÃ£o consta no schema padrÃ£o
    ...
    if ($stmt->execute()) {
        // CORREÃ‡ÃƒO AQUI: Usando a funÃ§Ã£o do utils.php
            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4 col-12 d-flex align-items-end">
                        <button type="button" id="add-produto" class="btn btn-success btn-block">Adicionar Ã  Compra</button>
                    </div>
                </div>
            </div>
        </div>
      ...
      <form action="compras.php" method="POST">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="cpf_cnpj" class="form-control mask-doc" placeholder="Apenas nÃºmeros">
              </div>
...
// MÃ¡scara simples para telefone e documento (visual)
...
$(document).ready(function() {
    ...
    $('#add-produto').on('click', function() {
        ...
        if ($('#compra-items').find(`tr[data-id="${produtoId}"]`).length > 0) {
            alert('Este produto jÃ¡ foi adicionado.'); return;
        }
