...
$titulo = ($status === 'baixada') ? 'RelatÃ³rio de Recebimentos' : 'Contas a Receber';
$sheet->setTitle(substr($titulo, 0, 30));

$headers = ['A'=>'Cliente', 'B'=>'NÃºmero', 'C'=>'DescriÃ§Ã£o', 'D'=>'Categoria', 'E'=>'Vencimento', 'F'=>'Valor'];
if ($status === 'baixada') {
