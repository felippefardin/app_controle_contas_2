...
if (!isset($_SESSION['usuario_logado'])) {
    die(json_encode(['status' => 'error', 'message' => 'Ṇo autorizado']));
}
...
if ($acao === 'baixar') {
    ...
    // NOTA: Aqui idealmente voc̻ tamb̩m inseriria no caixa_diario, 
    // mas para manter simples e ṇo alterar o fluxo complexo, focamos no status.
...
if ($stmt->execute()) {
    echo json_encode(['status' => 'success', 'message' => 'A̤̣o em massa realizada com sucesso!']);
} else {
