<?php
// Inicia o buffer para evitar que espaÃ§os em branco corrompam o arquivo
ob_start();
...
$tituloRelatorio = ($status === 'baixada') ? 'RelatÃ³rio de Contas Pagas' : 'RelatÃ³rio de Contas a Pagar';
...
// 5. ESTILIZAÃ‡ÃƒO (Apenas se nÃ£o for CSV)
if ($formato !== 'csv') {
...
// 6. LIMPEZA DE BUFFER E GERAÃ‡ÃƒO DO ARQUIVO
// Limpa qualquer HTML, espaÃ§o ou erro que tenha sido gerado antes deste ponto
ob_end_clean(); 
...
if ($formato === 'pdf') {
    ...
    // ConfiguraÃ§Ãµes de PÃ¡gina para PDF
