...
require_once '../includes/utils.php'; // FunÃ§Ã£o Display Flash estÃ¡ aqui
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    table { 
        ...
        min-width: 800px; /* ForÃ§a largura mÃ­nima para garantir layout no scroll */
    }
...
<div class="main-container">
    ...
    <form class="search-form" method="GET">
      ...
      <button type="button" class="btn btn-add" onclick="document.getElementById('addContaModal').style.display='flex'">âž• Nova</button>
...
<div id="exportModal" class="modal">
    <div class="modal-content">
        ...
        <form action="../actions/exportar_contas_pagar.php" method="GET" target="_blank" style="display:flex; flex-direction:column; gap:10px;">
            <label style="text-align:left; color:#ccc; font-size:12px;">Tipo de RelatÃ³rio:</label>
...
<div id="modalNovaCategoria" class="modal" style="z-index: 1060;">
  <div class="modal-content">
    ...
    <form id="form-nova-categoria" style="display:flex; flex-direction:column; gap:10px;">
        ...
        <input type="text" name="nome" required placeholder="Ex: EscritÃ³rio, Transporte...">
...
$('#form-nova-categoria').on('submit', function(e) {
    e.preventDefault();
    const formData = new FormData(this);
    formData.append('ajax', 'true'); // Sinaliza que Ã© AJAX
    ...
    $.ajax({
        ...
        success: function(resp) {
            if(resp.status === 'success' || resp.id) {
                // Adiciona a nova opÃ§Ã£o no Select
